...
**macOS, native app:** download [`Humanizer-0.1.1-arm64.dmg`](https://github.com/ancientcomputing/humanizer/releases/tag/0.1.1-macos), open it, and drag Humanizer into Applications. This is a
